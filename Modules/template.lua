...
if not loadedExternally then
    ...
    -- for MyUI use we will use the global MyUI. variables and functions.
    Module.Utils       = MyUI.Utils
    Module.Icons       = MyUI.Icons
    Module.Colors      = MyUI.Colors
    Module.ThemeLoader = MyUI.ThemeLoader
    Module.Icons       = MyUI.Icons -- if you need icons in your module
    -- Module.Colors      = MyUI.Colors -- if you need colors in your module
    -- Module.Icons       = MyUI.ICONS -- if you need icons in your module
