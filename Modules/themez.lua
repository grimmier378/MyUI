    ...
    if Module.ShowGui then
        ...
        if show then
                ...
                for i = 1, #sorteedKeys do
                    ...
                    if pData ~= nil and pID == ImGuiCol[sorteedKeys[i].name] then
                        ...
                        if propertyName ~= nil then
                            ...
                            local changed = false
                            pData.Color, changed = ImGui.ColorEdit4(pData.PropertyName .. "##", pData.Color)
                            ImGui.PopID()
                            if changed then
                                tempSettings.Theme[loadedID]['Color'][ImGuiCol[propertyName]] = {
                                    Color = pData,
            ...
            if ImGui.CollapsingHeader("Styles##") then
                sFlag = true
                ImGui.BeginChild('Styles', cWidth, (cFlag and headerHeight * 0.5 or headerHeight) - 20, ImGuiChildFlags.Borders)
