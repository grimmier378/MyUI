...
function Utils.DropShadow(str, options, shadCol, txtCol)
    options                 = options or {}
    local enabled           = options.Enabled ~= nil and options.Enabled or false
    local opacity           = options.Opacity or 0.8
...
function Utils.PrintOutput(mychat_tab, main_console, msg, ...)
    ...
    if mychat_tab == nil then
        print(msg)
    elseif MyUI.MyChatHandler ~= nil and main_console then
        MyUI.MyChatHandler(mychat_tab, msg)
        print(msg)
    elseif MyUI.MyChatHandler ~= nil then
        MyUI.MyChatHandler(mychat_tab, msg)
    else
        print(msg)
    end
